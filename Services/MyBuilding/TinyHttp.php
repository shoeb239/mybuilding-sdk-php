...
class Services_MyBuilding_TinyHttpException extends ErrorException {}

class Services_MyBuilding_TinyHttp {
  ...
  public function __call($name, $args) {
    ...
    case 'put':
      ...
      if (strlen($req_body)) {
        ...
        } else throw new Services_MyBuilding_TinyHttpException('unable to open temporary file');
      }
      break;
    case 'head':
    ...
    try {
      if ($curl = curl_init()) {
        if (curl_setopt_array($curl, $opts)) {
          ...
          } else throw new Services_MyBuilding_TinyHttpException(curl_error($curl));
        } else throw new Services_MyBuilding_TinyHttpException(curl_error($curl));
      } else throw new Services_MyBuilding_TinyHttpException('unable to initialize cURL');
